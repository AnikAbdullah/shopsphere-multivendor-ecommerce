  ...
  if (orderSuccess) {
    return (
      <main className="min-h-screen bg-white px-4 py-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl rounded-[2rem] bg-emerald-50 p-10 text-center">
  ...
  return (
    <main className="min-h-screen bg-white px-4 py-10 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
        ...
        {orderError && (
          <div className="mb-6 rounded-[1.5rem] bg-red-50 p-4 text-sm font-bold text-red-600">
            {orderError}
          </div>
        )}
